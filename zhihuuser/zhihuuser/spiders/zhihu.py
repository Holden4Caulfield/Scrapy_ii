...
class ZhihuSpider(Spider):
    ...
    def start_requests(self):
        ...
        #yield Request('https://www.zhihu.com/people/ying-kai-chen/following?page=4',callback=self.parse_user)
        #yield Request('https://www.bilibili.com',callback=self.parse_user)
